...
def reg():
    ...
    try:
        to = open('/sdcard/.ali.txt', 'r').read()
    except (KeyError, IOError):
        reg2()

    r = requests.get('https://raw.githubusercontent.com/Red-Mafia/filecrack/main/server.txt').text
    if to in r:
...
def reg2():
    ...
    os.system('xdg-open https://wa.me/+92188214452')
    sav = open('/sdcard/.ali.txt', 'w')
    sav.write(id)
    sav.close()
